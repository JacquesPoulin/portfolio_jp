	...
	return (
		<section className='py-16 pt-12 lg:py-24 lg:pt-20'>
			<div className='container'>
				{/* <div className='bg-gradient-to-r from-yellow-300 to-emerald-400 text-gray-900 py-8 px-10 rounded-3xl'> */}
				<div className='relative bg-gradient-to-r from-emerald-300 to-sky-400 text-gray-900 py-8 px-10 rounded-3xl text-center md:text-left overflow-hidden z-0'>
					...
					<div className='flex flex-col md:flex-row md:justify-between lg:justify-around gap-8 md:gap-16 items-center'>
						<div>
